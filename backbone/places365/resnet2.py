...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.cached_layers = []#[6] #range(len(self.layers))
...
def resnet50(arch="resnet50", pretrained=False, progress=True, **kwargs):
    ...
    model =  _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, num_classes=365,
                   **kwargs)
